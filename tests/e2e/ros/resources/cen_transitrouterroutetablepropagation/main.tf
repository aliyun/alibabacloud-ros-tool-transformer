...
resource "alicloud_cen_transit_router_route_table_propagation" "centransit_router_route_table_propagation" {
...
output "transit_router_route_table_id" {
  value       = alicloud_cen_transit_router_route_table_propagation.centransit_router_route_table_propagation.transit_router_route_table_id
  description = "TransitRouterRouteTableId"
}

output "transit_router_attachment_id" {
  value       = alicloud_cen_transit_router_route_table_propagation.centransit_router_route_table_propagation.transit_router_attachment_id
